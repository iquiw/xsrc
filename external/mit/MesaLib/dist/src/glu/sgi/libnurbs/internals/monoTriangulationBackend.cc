...
**
** $Date: 2008/07/29 05:10:37 $ $Revision: 1.1 $
*/
/*
** $Header: /garbage/cvs-mirror/xsrc/external/mit/MesaLib/dist/src/glu/sgi/libnurbs/internals/Attic/monoTriangulationBackend.cc,v 1.1 2008/07/29 05:10:37 mrg Exp $
*/
