...
**
** $Date: 2008/07/29 05:10:36 $ $Revision: 1.1 $
*/
/*
** $Header: /garbage/cvs-mirror/xsrc/external/mit/MesaLib/dist/src/glu/sgi/libnurbs/internals/Attic/dataTransform.cc,v 1.1 2008/07/29 05:10:36 mrg Exp $
*/
