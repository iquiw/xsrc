 ...
 * knotvector.c++
 *
 * $Date: 2001/06/09 15:20:51 $ $Revision: 1.1 $
 * $Header: /garbage/cvs-mirror/xsrc/xfree/xc/extras/ogl-sample/main/gfx/lib/glu/libnurbs/internals/Attic/knotvector.cc,v 1.1 2001/06/09 15:20:51 tron Exp $
 */
