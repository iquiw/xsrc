...
**
** $Date: 2006/04/22 15:22:59 $ $Revision: 1.1 $
*/
/*
** $Header: /garbage/cvs-mirror/xsrc/dist/Mesa/src/glu/sgi/libnurbs/nurbtess/Attic/monoTriangulation.cc,v 1.1 2006/04/22 15:22:59 macallan Exp $
*/
