...
**
** $Date: 2006/04/22 15:23:01 $ $Revision: 1.1 $
*/
/*
** $Header: /garbage/cvs-mirror/xsrc/dist/Mesa/src/glu/sgi/libnurbs/nurbtess/Attic/primitiveStream.cc,v 1.1 2006/04/22 15:23:01 macallan Exp $
*/
