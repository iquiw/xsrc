...
**
** $Date: 2006/04/22 15:23:02 $ $Revision: 1.1 $
*/
/*
** $Header: /garbage/cvs-mirror/xsrc/dist/Mesa/src/glu/sgi/libnurbs/nurbtess/Attic/sampleCompBot.cc,v 1.1 2006/04/22 15:23:02 macallan Exp $
*/
