...
**
** $Date: 2006/04/22 15:22:52 $ $Revision: 1.1 $
*/
/*
** $Header: /garbage/cvs-mirror/xsrc/dist/Mesa/src/glu/sgi/libnurbs/internals/Attic/dataTransform.cc,v 1.1 2006/04/22 15:22:52 macallan Exp $
*/
