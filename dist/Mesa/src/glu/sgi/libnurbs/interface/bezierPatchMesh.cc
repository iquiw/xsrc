...
**
** $Date: 2006/04/22 15:22:46 $ $Revision: 1.1 $
*/
/*
** $Header: /garbage/cvs-mirror/xsrc/dist/Mesa/src/glu/sgi/libnurbs/interface/Attic/bezierPatchMesh.cc,v 1.1 2006/04/22 15:22:46 macallan Exp $
*/
