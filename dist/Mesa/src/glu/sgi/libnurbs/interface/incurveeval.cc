...
**
** $Date: 2006/04/22 15:22:47 $ $Revision: 1.1 $
*/
/*
** $Header: /garbage/cvs-mirror/xsrc/dist/Mesa/src/glu/sgi/libnurbs/interface/Attic/incurveeval.cc,v 1.1 2006/04/22 15:22:47 macallan Exp $
*/
